...
function search() {
    const query = {}
    if (keywords.value) query.search = keywords.value
    if (city.value) query.city = city.value
    if (Object.keys(query).length === 0) {
        return router.visit(route('dashboard'))
    }
    router.visit(route('search', query))
}
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between gap-2 h-16">
                    ...
                    <div class="flex items-center gap-3 flex-1">
                        <TextInput v-model="keywords" placeholder="Search anything" class="w-1/2" />
                        <div class="w-1/3">
                            <CityAutocomplete @update:city="city = $event" />
                        </div>
                        <button @click="search"
                        ...
                        <div class="ms-3 relative">
                            <Dropdown v-if="authUser" align="right" width="48">
                                ...
                                <template #content>
                                    ...
                                    <DropdownLink :href="route('events.mine')">
                                        My Events
                                    </DropdownLink>
                                    <DropdownLink :href="route('participations.mine')">
                                        My Participations
                                    </DropdownLink>
                                    <DropdownLink :href="route('chats.mine')">My Chats</DropdownLink>
                ...
                <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                    <template v-if="authUser">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink :href="route('events.mine')">
                                My Events
                            </ResponsiveNavLink>
